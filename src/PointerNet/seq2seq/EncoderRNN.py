...
class EncoderRNN(BaseRNN):
    ...
    def __init__(self, vocab_size, max_len, hidden_size, input_dropout_p,
                 output_dropout_p, n_layers, bidirectional, rnn_cell,
                 variable_lengths, embedding=None, update_embedding=True):
        super(EncoderRNN, self).__init__(vocab_size, max_len, hidden_size,
                                         input_dropout_p, output_dropout_p, n_layers, rnn_cell)
